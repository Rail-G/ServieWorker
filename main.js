...
class NewsController {
  ...
  sendRequest() {
    ...
    const obs$ = interval(5000).pipe(take(5), mergeMap(() => {
  ...
  drawNewsPage(value) {
    ...
    this.newsBody.insertAdjacentHTML('afterbegin', NewsController.newsBlock(value));
  }
  setDefaultTheme() {
    for (let i = 0; i < 5; i++) {
      this.newsBody.insertAdjacentHTML('afterbegin', NewsController.defaultTheme());
    }
  }
  removeDefaultTheme() {
    this.newsBody.innerHTML = '';
